...
/// flutter/packages/flutter_tools/lib/src/artifacts.dart. It supports the use
/// of [FlutterTestDriver].
...
class EngineBuildPaths {
  const EngineBuildPaths(
      {@required this.targetEngine, @required this.hostEngine})
...
class CachedArtifacts extends Artifacts {
  ...
  String _getHostArtifactPath(
    ...
    switch (artifact) {
      ...
      case Artifact.platformKernelDill:
        return fs.path
            .join(_getFlutterPatchedSdkPath(), _artifactToFileName(artifact));
      case Artifact.platformLibrariesJson:
        return fs.path.join(
            _getFlutterPatchedSdkPath(), 'lib', _artifactToFileName(artifact));
      case Artifact.flutterPatchedSdkPath:
