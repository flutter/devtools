...
function requirePerfetto_version () {
	...
	perfetto_version.VERSION = "v43.2-ffde061a6";
	perfetto_version.SCM_REVISION = "ffde061a62baccd6b8badfe073bc19969511213a";
...
function requireLogging () {
	...
	logging.assertUnreachable = logging.reportError = logging.addErrorHandler = logging.assertFalse = logging.assertTrue = logging.assertExists = void 0;
