...
exports.VERSION = "v30.0-8d760d3b2";
exports.SCM_REVISION = "8d760d3b2a25abefae6fd63be3a095ae5bfb8d59";
...
function assertTrue(value, optMsg) {
    if (!value) {
        throw new Error(optMsg !== null && optMsg !== void 0 ? optMsg : 'Failed assertion');
    }
}
...
var traceconv = createCommonjsModule(function (module, exports) {
var traceconv_wasm = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(traceconv_wasm) {
  traceconv_wasm = traceconv_wasm || {};

var Module = typeof traceconv_wasm !== "undefined" ? traceconv_wasm : {};
...
var wasmBinaryFile = "traceconv.wasm";
...
Module["dynCall_viiiiji"] = createExportWrapper("dynCall_viiiiji", asm);
...
var traceconv_1 = createCommonjsModule(function (module, exports) {
// Copyright (C) 2021 The Android Open Source Project
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
function fsNodeToBuffer(fsNode) {
    const fileSize = (0, logging.assertExists)(fsNode.usedBytes);
    return new Uint8Array(fsNode.contents.buffer, 0, fileSize);
}
function runTraceconv(trace, args) {
    return tslib.__awaiter(this, void 0, void 0, function* () {
        const deferredRuntimeInitialized = (0, deferred.defer)();
        ...
        module.FS.mkdir('/fs');
        module.FS.mount((0, logging.assertExists)(module.FS.filesystems.WORKERFS), { blobs: [{ name: 'trace.proto', data: trace }] }, '/fs');
...
function ConvertTraceAndDownload(trace, format, truncate) {
    return tslib.__awaiter(this, void 0, void 0, function* () {
        ...
        updateJobStatus(jobName, conversion_jobs.ConversionJobStatus.InProgress);
        ...
        try {
            const module = yield runTraceconv(trace, args);
            const fsNode = module.FS.lookupPath(outPath).node;
            downloadFile(fsNodeToBuffer(fsNode), `trace.${format}`);
            module.FS.unlink(outPath);
        }
        finally {
            updateJobStatus(jobName, conversion_jobs.ConversionJobStatus.NotRunning);
        }
    });
}
...
function ConvertTraceAndOpenInLegacy(trace, truncate) {
    return tslib.__awaiter(this, void 0, void 0, function* () {
...
function ConvertTraceToPprof(trace, pid, ts) {
    return tslib.__awaiter(this, void 0, void 0, function* () {
...
selfWorker.onmessage = (msg) => {
    self.addEventListener('error', (e) => (0, logging.reportError)(e));
    self.addEventListener('unhandledrejection', (e) => (0, logging.reportError)(e));
    (0, logging.setErrorHandler)((err) => forwardError(err));
    const args = msg.data;
