...
class WasmBridge {
    ...
    initialize(port) {
        ...
        (0, logging.assertTrue)(this.messagePort === undefined);
    ...
    onMessage(msg) {
        ...
        (0, logging.assertTrue)(msg.data instanceof Uint8Array);
        const data = msg.data;
        let wrSize = 0;
    ...
    onReply(heapPtr, size) {
        ...
        (0, logging.assertExists)(this.messagePort).postMessage(data, [data.buffer]);
    }
...
selfWorker.onmessage = (msg) => {
    const port = (0, logging.assertExists)(msg.data.enginePort);
