...
function requirePerfetto_version () {
	...
	perfetto_version.VERSION = "v33.0-a38eb95ac";
	perfetto_version.SCM_REVISION = "a38eb95acf21b58d8f34393480f8aec1120c6115";
...
function requireLogging () {
	...
	const version = requirePerfetto_version();
	let errorHandler = (_) => { };
...
function requireWasm_bridge () {
	...
	const initTraceProcessor = requireTrace_processor();
