...
* Minor fixes to prepare for release [#5319](https://github.com/flutter/devtools/pull/5319)
...
* Updating from 2.22.0-dev.13 to 2.22.0-dev.14 [#5274](https://github.com/flutter/devtools/pull/5274)
* Updating from 2.22.0-dev.12 to 2.22.0-dev.13 [#5273](https://github.com/flutter/devtools/pull/5273)
* Updating from 2.22.0-dev.11 to 2.22.0-dev.12 [#5260](https://github.com/flutter/devtools/pull/5260)
* Add github workflow to close stale issues [#5249](https://github.com/flutter/devtools/pull/5249)
* Updating from 2.22.0-dev.10 to 2.22.0-dev.11 [#5257](https://github.com/flutter/devtools/pull/5257)
* - [#5256](https://github.com/flutter/devtools/pull/5256)
...
* Updating from 2.22.0-dev.9 to 2.22.0-dev.10 [#5255](https://github.com/flutter/devtools/pull/5255)
...
* Updating from 2.22.0-dev.8 to 2.22.0-dev.9 [#5247](https://github.com/flutter/devtools/pull/5247)
...
* # Something went wrong. Please input this CHANGELOG entry manually: "Change daily dev bumps to midnight Pacific Time"
* Updating from 2.22.0-dev.7 to 2.22.0-dev.8 [#5238](https://github.com/flutter/devtools/pull/5238)
* Updating from 2.22.0-dev.6 to 2.22.0-dev.7 [#5236](https://github.com/flutter/devtools/pull/5236)
* Updating from 2.22.0-dev.5 to 2.22.0-dev.6 [#5235](https://github.com/flutter/devtools/pull/5235)
...
* Updating from 2.22.0-dev.4 to 2.22.0-dev.5 [#5225](https://github.com/flutter/devtools/pull/5225)
...
* Updating from 2.22.0-dev.3 to 2.22.0-dev.4 [#5217](https://github.com/flutter/devtools/pull/5217)
* Change filter default to show only project and 3rd party dependencies [#5201](https://github.com/flutter/devtools/pull/5201)
* Updating from 2.22.0-dev.2 to 2.22.0-dev.3 [#5214](https://github.com/flutter/devtools/pull/5214)
...
* Updating from 2.22.0-dev.1 to 2.22.0-dev.2 [#5211](https://github.com/flutter/devtools/pull/5211)
...
* Updating from 2.22.0-dev.0 to 2.22.0-dev.1 [#5169](https://github.com/flutter/devtools/pull/5169)
...
* # Something went wrong. Please input this CHANGELOG entry manually: "Change Version to 2.22.0-dev.0"
...
* Cleanups to the release instructions readme [#5158](https://github.com/flutter/devtools/pull/5158)
...
* Move object_tree.dart to diagnostics and split to smaller files [#5082](https://github.com/flutter/devtools/pull/5082)
...
* Enable console for memory screen [#4993](https://github.com/flutter/devtools/pull/4993)
