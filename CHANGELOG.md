...
* Hide TODOs in VS Code when opening packages/devtools_app [#5600](https://github.com/flutter/devtools/pull/5600)
* Updated `getListHelper` instance ref argument to be nullable [#5549](https://github.com/flutter/devtools/pull/5549)
* Add actions to DevToolsScaffold by default [#5592](https://github.com/flutter/devtools/pull/5592)
* Polish the embedded Perfetto trace viewer [#5584](https://github.com/flutter/devtools/pull/5584)
* Updating from 2.23.0-dev.28 to 2.23.0-dev.29 [#5599](https://github.com/flutter/devtools/pull/5599)
* Updating from 2.23.0-dev.27 to 2.23.0-dev.28 [#5598](https://github.com/flutter/devtools/pull/5598)
* Updating from 2.23.0-dev.26 to 2.23.0-dev.27 [#5595](https://github.com/flutter/devtools/pull/5595)
* Automation improvements for the release process [#5558](https://github.com/flutter/devtools/pull/5558)
* Move some items out of adopted_heap_data.dart to make it observable [#5580](https://github.com/flutter/devtools/pull/5580)
* Fix golden test failures at master [#5586](https://github.com/flutter/devtools/pull/5586)
...
* Turn off eval for profile mode [#5553](https://github.com/flutter/devtools/pull/5553)
...
* Bump version from 2.23.0-dev.6 to 2.23.0-dev.7 [#5386](https://github.com/flutter/devtools/pull/5386)
