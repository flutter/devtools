...
class VmServiceWrapper implements VmService {
  ...
  final Set<String> _activeStreams = Set();
  ...
  Future<Breakpoint> addBreakpointAtEntry(
      ...
      _trackFuture(_vmService.addBreakpointAtEntry(isolateId, functionId));

  @override
  Future<Breakpoint> addBreakpointWithScriptUri(
          String isolateId, String scriptUri, int line, {int column}) =>
      _trackFuture(_vmService.addBreakpointWithScriptUri(
  ...
  Future<Response> callServiceExtension(String method,
      ...
      _trackFuture(_vmService.callServiceExtension(method,
  ...
  Future<Success> collectAllGarbage(String isolateId) =>
      _trackFuture(_vmService.collectAllGarbage(isolateId));
  ...
  Future evaluateInFrame(String isolateId, int frameIndex, String expression,
          {Map<String, String> scope}) =>
      _trackFuture(_vmService.evaluateInFrame(isolateId, frameIndex, expression,
          scope: scope));

  @override
  Future<AllocationProfile> getAllocationProfile(String isolateId,
          {String gc, bool reset}) =>
      _trackFuture(_vmService.getAllocationProfile(isolateId));

  @override
  Future<CpuProfile> getCpuProfile(String isolateId, String tags) =>
      _trackFuture(_vmService.getCpuProfile(isolateId, tags));
  ...
  Future<ObjRef> getInstances(String isolateId, String classId, int limit) =>
      _trackFuture(_vmService.getInstances(isolateId, classId, limit));

  @override
  Future getIsolate(String isolateId) =>
      _trackFuture(_vmService.getIsolate(isolateId));

  @override
  Future getObject(String isolateId, String objectId,
          {int offset, int count}) =>
      _trackFuture(_vmService.getObject(isolateId, objectId));

  @override
  Future<ScriptList> getScripts(String isolateId) =>
      _trackFuture(_vmService.getScripts(isolateId));
  ...
  Future<SourceReport> getSourceReport(
          ...
          int endTokenPos,
          bool forceCompile}) =>
      _trackFuture(_vmService.getSourceReport(isolateId, reports,
          scriptId: scriptId,
          tokenPos: tokenPos,
  ...
  Future<Stack> getStack(String isolateId) =>
      _trackFuture(_vmService.getStack(isolateId));
  ...
  Future<Success> kill(String isolateId) =>
      _trackFuture(_vmService.kill(isolateId));
  ...
  Future<Success> removeBreakpoint(String isolateId, String breakpointId) =>
      _trackFuture(_vmService.removeBreakpoint(isolateId, breakpointId));
  ...
  Future<Success> setExceptionPauseMode(String isolateId, String mode) =>
      _trackFuture(_vmService.setExceptionPauseMode(isolateId, mode));

  @override
  Future<Success> setFlag(String name, String value) =>
      _trackFuture(_vmService.setFlag(name, value));
  ...
  Future<Success> setName(String isolateId, String name) =>
      _trackFuture(_vmService.setName(isolateId, name));

  @override
  Future<Success> setVMName(String name) =>
      _trackFuture(_vmService.setVMName(name));

  @override
  Future<Success> setVMTimelineFlags(List<String> recordedStreams) =>
      _trackFuture(_vmService.setVMTimelineFlags(recordedStreams));
  ...
  Future<Success> streamListen(String streamId) {
    ...
    if (!_activeStreams.contains(streamId)) {
      future = _trackFuture(_vmService.streamListen(streamId));
    }
  ...
  Future<T> _trackFuture<T>(Future<T> future) {
    ...
    future.whenComplete(() {
      ...
      if (_activeFutures.isEmpty && !noPendingFutures.isCompleted) {
