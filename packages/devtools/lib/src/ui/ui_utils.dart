...
/// Catch and print errors from the given future. These errors are part of normal
/// operation for an app, and don't need to be reported to analytics (i.e., they're
/// not DevTools crashes).
