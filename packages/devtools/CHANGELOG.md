## 2.7.0
* Revert ProgramExplorer changes [#3417](https://github.com/flutter/devtools/pull/3417)
* Remove temporary package:archive workaround [#3416](https://github.com/flutter/devtools/pull/3416)
* Fix file:line:col color fixed (#3249) [#3365](https://github.com/flutter/devtools/pull/3249) (#3365)
* [Cleanup] Moved test helper code from "test/support" to a new "devtools_test" package [#3406](https://github.com/flutter/devtools/pull/3406)
* Fix the build to workaround issue with package:archive [#3414](https://github.com/flutter/devtools/pull/3414)
* Upgrade to DDS version 2.1.3 [#3404](https://github.com/flutter/devtools/pull/3404)
* Fix null exception in program explorer code [#3405](https://github.com/flutter/devtools/pull/3405)
...
* Fix issue where initial script was not always selected in File Explorer [#3400](https://github.com/flutter/devtools/pull/3400)
* Show a spinner while loading program outline in file explorer [#3399](https://github.com/flutter/devtools/pull/3399)
* Hide synthetic classes created by mixin applications in outline view [#3398](https://github.com/flutter/devtools/pull/3398)
* Don't scroll code view to top when opening/closing file explorer [#3395](https://github.com/flutter/devtools/pull/3395)
...
* Replace `ScriptPicker` with `ProgramExplorer` on `DebuggerScreen` [#3227](https://github.com/flutter/devtools/pull/3227)
* Changed the issue link to go straight to filing an issue (#2915) [#3373](https://github.com/flutter/devtools/pull/2915) (#3373)
...
* [Debugger] - 'Step Over' button before 'Step in' [#3379](https://github.com/flutter/devtools/pull/3379)
* Prepare for v2.6.1-dev.1 release [#3370](https://github.com/flutter/devtools/pull/3370)
* [Cleanup] Merge InspectorTreeControllerFlutter and superclass into single InspectorTreeController class [#3367](https://github.com/flutter/devtools/pull/3367)
...
* Revert "Don't wait on stream listening in DevTools start up (#3333) [#3351](https://github.com/flutter/devtools/pull/3333)" (#3351)
