...
class ClientManager {
  ...
  /// Finds an active DevTools instance that is not already connecting to a VM
  /// service that we can reuse (for example if a user stopped debugging and it
  /// disconnected, then started debugging again, we want to reuse the open
  /// DevTools window).
