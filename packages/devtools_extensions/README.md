...
extension. Copy the `config.yaml` file below and fill in the appropriate value for each key.
...
```json
{
    ...
    "configurations": [
        ...
        {
            ...
            "program": "foo/packages/foo_devtools_extension/lib/main.dart",
            "request": "launch",
            "type": "dart",
            "args": [
