...
class EventDetails extends StatelessWidget {
  ...
  final LegacyTimelineEvent selectedEvent;
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Provider.of<LegacyPerformanceController>(context);
  ...
  String _generateHeaderText(LegacyTimelineEvent event) {
...
class EventSummary extends StatelessWidget {
  ...
  final LegacyTimelineEvent event;

  final List<LegacyAsyncTimelineEvent> _connectedEvents;
