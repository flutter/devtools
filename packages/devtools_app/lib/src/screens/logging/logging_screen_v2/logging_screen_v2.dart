...
class _LoggingScreenState extends State<LoggingScreenBody>
  ...
  Widget _buildLoggingControls() {
    ...
    return Row(
      children: [
        ...
        SearchField<LoggingControllerV2>(
    ...
    return SplitPane(
      ...
      children: [
        RoundedOutlinedBorder(
          clip: true,
          child: Container(), // Empty container to avoid unnecessary copying.
        ),
        ValueListenableBuilder<LogDataV2?>(
          valueListenable: controller.selectedLog,
          builder: (context, selected, _) {
            return Container(); // Empty container to avoid unnecessary copying.
          },
        ),
      ],
    );
  ...
  void _showFilterDialog() {
    unawaited(
      showDialog(
        context: context,
        builder: (context) => FilterDialog<LogDataV2>(
