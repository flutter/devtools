...
// class FrameAnalysis extends StatelessWidget {
//   const FrameAnalysis({
//     Key key,
//     @required this.flutterFrame,
//     @required this.onClosed,
//     @required this.overlayWidth,
//   }) : super(key: key);
//
//   final FlutterFrame flutterFrame;
//
...
//     final uiEvent = flutterFrame.timelineEventData.uiEvent;
//     return Material(
...
//             color: theme.colorScheme.overlayBackgroundColor,
//             borderRadius: BorderRadius.circular(defaultBorderRadius),
//           ),
//           child: Column(
//             mainAxisSize: MainAxisSize.min,
//             children: [
//               dialogTitleText(theme, 'Frame Analysis'),
//               const SizedBox(height: defaultSpacing),
//               UiPhaseAnalysisTile(
//                 title: 'Build',
//                 events: uiEvent?.buildEvents ?? [],
//                 canAnalyzeCallback: (event) => event.canAnalyzeBuild,
//                 helpInstructions:
//                     'To investigate the Build phase for this frame, try enabling '
//                     'the \'Track Widget Builds\' feature in the \'Enhance Tracing\''
//                     ' menu, and reproducing this frame in your app.',
//               ),
//               UiPhaseAnalysisTile(
//                 title: 'Layout',
//                 events: [if (uiEvent?.layoutEvent != null) uiEvent.layoutEvent],
//                 canAnalyzeCallback: (event) => event.canAnalyzeLayout,
//                 helpInstructions:
//                     'To investigate the Layout phase for this frame, try enabling '
//                     'the \'Track Layouts\' feature in the \'Enhance Tracing\''
//                     ' menu, and reproducing this frame in your app.',
//               ),
//               UiPhaseAnalysisTile(
//                 title: 'Paint',
//                 events: [if (uiEvent?.paintEvent != null) uiEvent.paintEvent],
//                 canAnalyzeCallback: (event) => event.canAnalyzePaint,
//                 helpInstructions:
//                     'To investigate the Paint phase for this frame, try enabling '
//                     'the \'Track Paints\' feature in the \'Enhance Tracing\''
//                     ' menu, and reproducing this frame in your app.',
//               ),
//               const SizedBox(height: defaultSpacing),
//               TextButton(
...
// }
//
// class UiPhaseAnalysisTile extends StatelessWidget {
//   const UiPhaseAnalysisTile({
//     Key key,
//     @required this.title,
//     @required this.events,
//     @required this.canAnalyzeCallback,
//     @required this.helpInstructions,
//   }) : super(key: key);
//
//   final String title;
//
...
//
//   final bool Function(SyncTimelineEvent) canAnalyzeCallback;
//
//   final String helpInstructions;
//
//   @override
//   Widget build(BuildContext context) {
...
//       children: _canAnalyze()
//           ? [
//               Container(height: 20.0, width: 100.0, color: Colors.green),
...
//
//   bool _canAnalyze() {
//     var canAnalyzeEvents = false;
//     for (final event in events) {
//       if (canAnalyzeCallback(event)) {
//         canAnalyzeEvents = true;
//         break;
//       }
//     }
//     return canAnalyzeEvents;
//   }
// }
