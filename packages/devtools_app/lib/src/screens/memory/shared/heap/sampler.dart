...
class _HeapObjects_ {
  _HeapObjects_(this.objects, this.heap);
...
class ClassSampler_ {
  ClassSampler_(
    ...
    AdaptedHeapData? heap,
        ...
        _objects = objects == null ? null : _HeapObjects_(objects, heap!);

  final HeapClassName heapClass;
  final _HeapObjects_? _objects;
  ...
  Future<void> allLiveToConsole({
    ...
    serviceConnection.consoleService.appendBrowsableInstance(
      ...
      heapSelection: selection == null
          ? null
          : HeapObjectSelection_(selection.heap, object: null),
    );
  }
...
class HeapClassSampler_ extends ClassSampler_ {
  HeapClassSampler_(
