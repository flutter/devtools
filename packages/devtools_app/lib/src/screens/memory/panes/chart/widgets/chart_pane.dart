...
*/
              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    if (controller
                        .controllers.chart.isAndroidChartVisible.value)
                      SizedBox(
  ...
  void dispose() {
    ...
    controller.controllers.chart.stopTimeLine();
    super.dispose();
  }
  ...
  void _showHover(
    ...
    int totalTraces;
    totalTraces = controller.controllers.chart.isAndroidChartVisible.value
