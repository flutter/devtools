...
// To run:
// dart run integration_test/run_tests.dart --target=integration_test/test/live_connection/memory/diff_eval_and_browse_test.dart
...
void main() {
  ...
  testWidgets('memory diff eval and browse', (tester) async {
