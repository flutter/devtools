  ...
  group('PerformanceController', () {
    ...
    test(
      ...
      () async {
        ...
        await performanceController
            .selectTimelineEvent(animatorBeginFrameEvent);
    ...
    test(
      ...
      () async {
        ...
        performanceController
            .addTimelineEvent(goldenUiTimelineEvent..deepCopy());
        expect(performanceController.matchesForSearch('test'), isEmpty);
    ...
    test(
      'search query searches through previous matches',
      () async {
        await env.setupEnvironment();
