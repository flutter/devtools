...
void main() {
  ...
  testWidgetsWithWindowSize('Call Stack shows items', windowSize, (
    ...
    expect(find.byTooltip('testCodeRef script.dart:0'), findsOneWidget);
      ...
      find.byWidgetPredicate(
        (Widget widget) =>
            ...
            widget.text.toPlainText().contains(
              'testCodeRef3.<closure> script3.dart:3',
            ),
      ),
      findsOneWidget,
    );
    ...
    expect(
      find.byWidgetPredicate(
        (Widget widget) =>
            widget is RichText &&
            widget.text.toPlainText().contains(
              '<native code: _createTimer> client.js',
            ),
      ),
      findsOneWidget,
    );
