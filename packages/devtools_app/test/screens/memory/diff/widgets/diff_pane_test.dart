...
void main() {
  ...
  group('Diff pane', () {
    ...
    testWidgetsWithWindowSize('records and deletes snapshots', windowSize, (
      ...
      expect(find.byType(DiffPane), findsOneWidget);
      expect(find.byTooltip('Delete all snapshots'), findsOneWidget);
      ...
      await tester.pumpAndSettle();
      expect(snapshots.value.length, equals(1));
      expect(find.textContaining('selected-isolate-'), findsNothing);
    });
  });
}
