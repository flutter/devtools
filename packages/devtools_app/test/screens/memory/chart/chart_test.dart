  ...
  group('Chart Timeseries', () {
    ...
    void loadData() {
      ...
      if (!memoryJasonInitialized) {
        memoryJson = SamplesMemoryJson.decode(
    ...
    void addDataToTrace(ChartController controller, int traceIndex, Data data) {
    ...
    testWidgetsWithWindowSize('Scaled Y-axis live', windowSize, (
      WidgetTester tester,
    ) async {
    ...
    testWidgetsWithWindowSize('Fixed Y-axis', windowSize, (
      WidgetTester tester,
    ) async {
      const chartKey = Key('Chart');
      final controller = ChartController();
