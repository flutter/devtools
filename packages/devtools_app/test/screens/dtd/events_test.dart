    ...
    void addEvents() {
      final events = [
        DTDEvent(
          ...
          {
            EventParameters.uri: 'ws://127.0.0.1:30000/4G4UPw7fyoQ=/',
            EventParameters.exposedUri: 'ws://127.0.0.1:30000/4G4UPw7fyoQ=/',
            EventParameters.name: 'Flutter - Android (debug)',
          },
          0,
        ),
        DTDEvent(
          ...
          {
            EventParameters.uri: 'ws://127.0.0.1:40000/4G4UPw7fyoQ=/',
            EventParameters.exposedUri: 'ws://127.0.0.1:56050/4G4UPw7fyoQ=/',
            EventParameters.name: 'Flutter - iOS (debug)',
          },
          1,
        ),
      ];
