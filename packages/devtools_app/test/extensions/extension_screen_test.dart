...
void main() {
  ...
  group('$ExtensionScreen', () {
    ...
    setUp(() async {
      ...
      providerScreen = ExtensionScreen(
    ...
    testWidgetsWithWindowSize('renders for unactivated state', windowSize, (
      tester,
    ) async {
    ...
    testWidgetsWithWindowSize('renders for enabled state', windowSize, (
      tester,
    ) async {
    ...
    testWidgetsWithWindowSize('renders for disabled state', windowSize, (
      tester,
    ) async {
      await extensionService.setExtensionEnabledState(
        StubDevToolsExtensions.fooExtension,
    ...
    testWidgetsWithWindowSize(
      ...
      (tester) async {
        ...
        expect(find.byType(EmbeddedExtensionView), findsOneWidget);
        expect(find.byType(ExtensionRequiresConnection), findsNothing);
        await _verifyContextMenuContents(tester, autoDismiss: false);
