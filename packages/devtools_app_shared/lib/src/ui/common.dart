...
class DevToolsButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return maybeWrapWithTooltip(
      ...
      child: SizedBox(
        height: defaultButtonHeight,
        width: !isDisplayWiderThan(context, minScreenWidthForTextBeforeScaling)
            ? buttonMinWidth
            : null,
        child: outlined
            ? OutlinedButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        if (isDisplayWiderThan(context, unscaledMinIncludeTextWidth))
          Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        // TODO(jacobr): animate showing and hiding the text.
        if (label != null &&
            isDisplayWiderThan(context, minScreenWidthForTextBeforeScaling))
          Padding(
