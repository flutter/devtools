...
if [ "$BOT" = "main" ]; then
    ...
    if [ "$PLATFORM" = "vm" ]; then
        ...
        flutter test $DART_DEFINE_ARGS test/device_dialog_test.dart
        flutter test $DART_DEFINE_ARGS test/profiler_screen_controller_test.dart
        flutter test $DART_DEFINE_ARGS test/profiler_screen_test.dart
